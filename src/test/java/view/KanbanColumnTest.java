...
public class KanbanColumnTest {
    ...
    public void checkIfEmpty() {
        ...
        // Includes Column name label, buttons panel, and ScrollContainer
        assertEquals(3, col.getComponentCount());
    }

    @Test
    public void getNumberOfComponentsShouldBe53() {
        KanbanColumn col = new KanbanColumn("Name", ColumnRole.COMPLETED);
        for (int i = 0; i<50; i++) {
            col.add(new KanbanCardButton(col, "Card Name", "Card description", 10));
        }
        // Includes Column name label and ScrollContainer
        assertEquals(53, col.getComponentCount());
    }
